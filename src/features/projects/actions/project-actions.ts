    ...
    return dbProjects.map((p) => {
      ...
      return {
        ...
        owner: {
          ...
          avatarColor: p.ownerAvatarColor || "bg-amber-500 text-white",
        },
  ...
  try {
    ...
    const created = await db.project.create({
      data: {
        ...
        ownerAvatarColor: "bg-amber-500 text-white",
        status: "ACTIVE",
  ...
  try {
    ...
    return dbTasks.map((t) => ({
      ...
      remarks: t.remarks.map((r) => ({
        ...
        authorName: r.authorName,
        authorInitials: r.authorInitials,
        authorAvatarColor: r.authorAvatarColor || "bg-blue-600 text-white",
        content: r.content,
      ...
      assignees: [
        { id: "u-default", name: t.authorName, initials: "DP", avatarColor: "bg-amber-500 text-white" },
      ],
    }));
  } catch (error) {
  ...
  try {
    ...
    dbLogs.forEach((log) => {
      const group = userMap.get(log.userName) || {
        ...
        avatarColor: log.avatarColor || "bg-blue-600 text-white",
