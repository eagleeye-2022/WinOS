  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-5 overflow-y-auto p-6">
        ...
        {isReviewed && (
          <div className="flex items-center gap-3 rounded-lg border border-success/30 bg-success/10 px-4 py-3.5">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-success text-success-foreground font-bold text-sm">
              ✓
            </div>
            <div>
